...
class_names = ['politica','economia', 'deportes', 'cultura']
class_names = ['resto', 'deportes']
#
...
for positive_class in class_names:
    ...
    X_all_text, y_all = getDocuments(data, total_documents, positive_class)    
